...
//small test
int main(){
    STDtest std("/home/omer/BIU/pFlight/input.txt","/home/omer/BIU/pFlight/output.txt");
    CLI cli(&std);
    cli.start();
    std.close();
    check("/home/omer/BIU/pFlight/output.txt","/home/omer/BIU/pFlight/expectedOutput.txt");
    cout<<"done"<<endl;
    return 0;
